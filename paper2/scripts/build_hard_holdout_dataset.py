...
ROOT = Path("paper2/data/raw/hard_holdout_runs")
OUT = Path("paper2/data/processed/hard_holdout_dataset.csv")
...
for run_dir in sorted(ROOT.glob("*")):
    ...
    meta = atg.get("meta", {})
    family = meta.get("family", "hard_holdout")
    ...
    with analysis_file.open(newline="") as f:
        ...
        for r in reader:
            ...
            rows.append({
                "source_kind": "hard_holdout_analysis",
                "graph_id": graph_id,
                "family": family,
                "pair": r.get("pair", ""),
